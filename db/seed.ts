 ...
 *
 * Production note:
 * - This file is the single source of mock data used while the application is
 *   not yet connected to AWS Aurora PostgreSQL. Repositories (db/repositories)
 *   read from here today; once the database is connected, only the repository
 *   implementations change — the data shapes (types/index.ts) stay the same.
 * - Do NOT import this file directly from UI components. Go through the
 *   repositories/services so the data source can be swapped transparently.
 */
import {
  BrainCircuit,
  Database,
...
export const knowledgeItems: Document[] = [
  {
    id: 'k1',
...
export const knowledgeGrowth: KnowledgeGrowthPoint[] = [
...
export const studyActivity: StudyActivityPoint[] = [
  { day: 'Mon', minutes: 45 },
  { day: 'Tue', minutes: 80 },
  { day: 'Wed', minutes: 30 },
  { day: 'Thu', minutes: 95 },
...
export const graphEdges: ConceptConnection[] = [
  // Subject -> concept
...
export const aiCoach: Recommendation = {
  nextTopic: {
...
export const learningIntelligence: LearningIntelligence = {
